    ...
    <div className="flex flex-col min-h-screen w-full lg:flex-row">
      ...
      <aside className="w-full lg:w-96 flex flex-col glass-panel border-r border-slate-800 shrink-0">
        ...
        <div className="p-6 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Founder Intelligence System</p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          <p className="text-xs font-semibold text-slate-500 px-2 uppercase tracking-wider">Founders Workspace</p>
          {founders.map((f) => (
            <div
              key={f.id}
        ...
        {selectedFounderId ? (
          loadingDetails ? (
            <div className="flex-1 flex flex-col items-center justify-center gap-3">
              ...
              <p className="text-sm text-slate-400">Loading founder workspace details...</p>
            </div>
          ) : (
            <div className="flex-1 p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-8">
              ...
              <div className="glass-panel p-6 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-400 max-w-2xl">{selectedFounder?.bio}</p>
                </div>
                    ...
                    <div className="glass-panel p-6 rounded-2xl space-y-4">
                      ...
                      <form onSubmit={handleSaveTouchpoint} className="space-y-4">
                        <div className="space-y-1.5">
                          <label className="text-xs text-slate-400 uppercase tracking-wider font-semibold">Source Type</label>
                          <select
                        ...
                        <div className="space-y-1.5">
                          <label className="text-xs text-slate-400 uppercase tracking-wider font-semibold">Content</label>
                          <textarea
                      ...
                      {prepBrief?.observations.map((obs, idx) => (
                        <div key={idx} className="p-5 rounded-xl bg-slate-900/30 border border-slate-800 space-y-3 hover:border-slate-700 transition-all">
                          ...
                          <div className="flex flex-wrap gap-2 border-t border-slate-800/60 pt-3">
                            <span className="text-xs font-semibold uppercase tracking-wider text-slate-400 w-full mb-1">Sources</span>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between text-xs text-slate-400">
                            ...
                            <button
                              ...
                              className="text-slate-400 hover:text-white transition-all cursor-pointer flex items-center gap-1"
                            >
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center max-w-xl mx-auto">
            <Compass className="w-20 h-20 text-slate-800 stroke-1 mb-6 animate-pulse" />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-xl glass-panel rounded-2xl overflow-hidden shadow-2xl relative">
            <button
              ...
              className="absolute right-4 top-4 text-slate-400 hover:text-white transition-all cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="p-6 border-b border-slate-800">
              ...
              <p className="text-xs text-slate-400">Initialize a new profile in your relationship workspace</p>
            </div>
            ...
            <form onSubmit={handleCreateFounder} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Company Stage</label>
                  <select
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Tech Stack</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Bio Excerpt</label>
                <textarea
              ...
              <div className="flex justify-end gap-3 border-t border-slate-800 pt-4 mt-2">
                <button
                  type="button"
                  onClick={() => setShowAddModal(false)}
                  className="px-4 py-2.5 rounded-xl border border-slate-800 hover:bg-slate-900 text-slate-400 hover:text-white transition-all text-sm cursor-pointer"
                >
                  Cancel
                </button>
                <button
