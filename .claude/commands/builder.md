...
When the story is complete, write the handoff section to `current-loop.md` using the 5-section format in builder-directive.md, then stop. Do not pre-fix things you suspect Checker will find. Let Checker work.
